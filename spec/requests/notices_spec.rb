  ...
  describe "POST /create" do
    context "with valid parameters" do
      it "creates a new Notice" do
        expect {
          post notices_url, params: { notice: valid_attributes }
    ...
    context "with invalid parameters" do
      it "does not create a new Notice" do
        expect {
          post notices_url, params: { notice: invalid_attributes }
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested notice" do
        notice = Notice.create! valid_attributes
        patch notice_url(notice), params: { notice: new_attributes }
        notice.reload
      ...
      it "redirects to the notice" do
        ...
        patch notice_url(notice), params: { notice: new_attributes }
        notice.reload
        expect(response).to redirect_to(notice_url(notice))
      end
    end
    ...
    context "with invalid parameters" do
      ...
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        notice = Notice.create! valid_attributes
        patch notice_url(notice), params: { notice: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_entity)
      end
