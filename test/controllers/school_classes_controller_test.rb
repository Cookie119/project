...
class SchoolClassesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create school_class" do
    assert_difference("SchoolClass.count") do
      post school_classes_url, params: { school_class: { class_name: @school_class.class_name, is_active: @school_class.is_active, is_deleted: @school_class.is_deleted } }
    end
  ...
  test "should update school_class" do
    patch school_class_url(@school_class), params: { school_class: { class_name: @school_class.class_name, is_active: @school_class.is_active, is_deleted: @school_class.is_deleted } }
